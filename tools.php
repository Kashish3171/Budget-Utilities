...
<section class="page1_header" style="text-decoration-style: none;" >
     ...
     <div class="container" style="margin-left:3em;margin-top: 0em;text-decoration-style: none;"><div class="row">
        <div class="grid_4">
          ...
          <a  class=" banner " href="interestcalci.html" target="_blank"><div class="maxheight1">
            <div class="fa fa-building" ></div>Interest<br> calculator</div>
          </a>
          <a   data-toggle="modal" data-target="#myModal4" target="_blank" class="banner "><div class="maxheight1">
    ...
    <div class="grid_5" style="display:inline-block;float:right;margin-right:-4em;margin-top:5em;">
        ...
        <div class="grid_4" style="margin-left:1px;">
          <a   href="mortgageCalci.html" target="_blank" class="banner "><div class="maxheight">
           <div class="fa fa-cubes fa-5x" ></div>Mortgage<br> Calculator</div>
          </a>
          <a   href="autoloanCalci.html" target="_blank" class=" banner"><div class="maxheight">
           <div class="fa fa-motorcycle" id="login"></div>AutoLoan <br>Calculator</div>
          </a>
          <a  href="savingsCalci.html" target="_blank" class=" banner "><div class="maxheight1">
            <div class="fa fa-inr fa-5x" ></div>Savings<br>Calculator</div>
          </a>
          <a  href="ccPayment.html"  target="_blank" class="banner "><div class="maxheight1">
...
<div class="modal fade" id="myModal4" role="dialog">
    <div class="modal-dialog" style="width:13em;">
<div class="modal-content" >
 
<div id="FEXRdiv" style="margin-left:0em;"></div>
 </div></h2></div></div></div></div>
 <script type="text/javascript">
var FEXR_c = "EUR", FEXR_a = "INR", FEXR_amt = 1, FEXR_size = 200, FEXR_panel = 2, FEXR_button = 2;
</script>
<script type="text/javascript" src="//www.foreignexchangeresource.com/converterB.js"></script>


 </section></header></body></html>
