...
<script src="js/autoloan.js" type="text/javascript"></script>

<script src="js/autoloan2.js" type="text/javascript"></script>
<style>
...
<section class="page1_header" style="text-decoration-style: none;" >
    ...
    <div class="grid_5" style="display:inline-block;float:right;margin-right:-4em;margin-top:5em;">
        ...
        <div class="grid_4" style="margin-left:1px;">
          ...
          <a data-toggle="modal" data-target="#myModal1" class=" banner "><div class="maxheight1">
            <div class="fa fa-inr fa-5x" ></div>Savings<br>Calculator</div>
          </a>
          <a  class="banner "><div class="maxheight1">
...
<h2 class="modal-title">Credit Card Payment Calculator</h4></div>
...
<label for="balance">
   Balance</label>
    ...
    <input name="text" type="text" id="textA" class="form-control"
          onfocus="this.className='form-control'" 
          onkeydown="xdelay1('a')" value="" size="15" autocomplete="off" />
  </div> <div class="form-group">
<label for="balance">Interest Rate</label>
      
    <input name="text2" type="text" id="textB" class="form-control"
          onfocus="this.className='form-control'" 
          onkeydown="xdelay1('b')" value="" size="15" autocomplete="off"/> % per year
 </div>
 <div class="form-group">
<label for="balance">Months To payoff</label>
      <input name="text3" type="text" id="textC"
          onfocus="this.className='form-control'" 
          onkeydown="xdelay1('c')" value="" size="15" autocomplete="off" class="form-control"/>
</div>

 <div class="form-group">
<label for="balance">Monthly Payment</label>
     <input name="text5" 
            type="text" id="resultbox" 
      onkeydown="xdelay1('x')" value="" size="15" class="form-control"/></div>

  <p > *Change the Balance, Interest Rate, and Months to calculate the required monthly payment. Change the monthly payment to calculate the possible balance.</p>
</div></form>
  </h2></div></div></div></div>
