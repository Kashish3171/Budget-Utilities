...
$sql = "SELECT date1,date2,entry,amount FROM two WHERE email='$email' and password='$password'";
   mysql_select_db('budgetutility');
   $retval = mysql_query($sql, $conn);
       ...
       <div class="banner " href="myTasks.php" ><div class="maxheight"> <div class="fa fa-inr" id="login"> </div> My Balance<p style="color:black;"><?php echo $balance; ?></p>
        ...
        <p style="color:white;font-size: 20px;">Your account with details about your expenses. Expense between two different dates can also be viewed.
         ...
         <div class="grid_4" style="float:right;">
          <a class="banner " href="detailFetch.php" target="_blank"><div class="maxheight"> <div class="fa fa-file" id="login"> </div>Field wise expense <br>Details<br>
         </div> </a>
...
<div class="modal-body">
    <form method="POST" action="detailFetch1.php">
    <div class="form-group">
    <label for="date1">First Date</label>
  <input  type="date" name='date1' id='date1' class="form-control"  placeholder="date1" pattern="\d*" autofill='off' 
     autofocus="" autocomplete='off' ></div>  <div class="form-group">
     <label for="date2">Second Date</label>  <input  type="date" name='date2' id='date2' class="form-control"  placeholder="date2" pattern="\d*" autofill='off' 
     autofocus="" autocomplete='off' required></div>
     <div class="modal-footer">
<button type="submit" href="detailFetch1.php" target="_blank" class="btn btn-primary" >Fetch</a></button>
 </form>
   </div>    
