...
<!--==============================
              header
=================================-->
<header style='background-size: 170em;'>
...
$conn=mysql_connect('localhost','root','','budgetUtility');
  ...
  </section><section> <nav class="w3-sidenav w3-transparent w3-card-2" style="width:10%;height:100%;margin-top:0.1em;padding-top: em;background-color:grey;">
  <br>
 ...
 <section class="page1_header" style="text-decoration-style: none;" >
     ...
     <div class="container" style="margin-left:9em;margin-top: 1em;text-decoration-style: none;"><div class="row">
        <div class="grid_4">
          ...
          <a   data-toggle="modal" data-target="#myModal1" class="login-window banner"><div class="maxheight">
           <div class="fa fa-phone-square" id="login"></div>Phones</div>
          </a>
          <a  data-toggle="modal" data-target="#myModal2" class="signup-window banner "><div class="maxheight1">
        ...
        <div class="grid_4" style="margin-left:1px;">
          ...
          <a    data-toggle="modal" data-target="#myModal5" class="login-window banner"><div class="maxheight">
           <div class="fa fa-heartbeat fa-5x" id="login"></div>Medical</div>
          </a>
          <a  data-toggle="modal" data-target="#myModal6" class="signup-window banner "><div class="maxheight1">
...
<div class="grid_4" >
          ...
          <a    data-toggle="modal" data-target="#myModal9" class="login-window banner"><div class="maxheight">
          ...
          <a    data-toggle="modal" data-target="#myModal10" class="login-window banner"><div class="maxheight">
...
<div class="modal-content" >
<div class="modal-header">
<h2 class="modal-title">My Budget</h4></div>
<div class="modal-body">
